...
public class Zadatak_03 {
	...
	/**
	 * Program prints first 100 Emirp numbers.
	 * Emirp number is number that is not palindrome but his reversed value is also prime.
	 * @param args
	 */
	public static void main(String[] args) {
		// go trough numbers and stop when counter reaches 100
		for (int i = 0, counter = 0; counter < 100; i++) {
			// if current number is not palindrome
			if (!isPalindrome(i)) {
